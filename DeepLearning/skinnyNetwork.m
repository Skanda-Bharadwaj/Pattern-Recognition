%--------------------------------------------------------------------------
%% Deep Learning Basics : A Skinny neural net
%--------------------------------------------------------------------------
%
% A skinny neural net is when you have may layers but fewer filters
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
layers = [
    ...
    convolution2dLayer(7,10,'Padding',[2 2],'Stride', [2,2]);             % convolution layer with 20, 5x5 filters
    ...
    convolution2dLayer(5,20,'Padding',[1 1],'Stride', [1,1]);             % convolution layer with 20, 5x5 filters
    reluLayer();                                                          % ReLU layer
    ...
    convolution2dLayer(3,30,'Padding',[1 1],'Stride', [1,1]);             % convolution layer with 20, 5x5 filters
    reluLayer();                                                          % ReLU layer
    maxPooling2dLayer(2,'Stride',2); 
    
    convolution2dLayer(3,20,'Padding',[1 1],'Stride', [1,1]);             % convolution layer with 20, 5x5 filters
    reluLayer();                                                          % ReLU layer
    maxPooling2dLayer(2,'Stride',2); 
...
savefig('TrainingConfusionMatrix_skinnyNet1.fig')
...
savefig('validationConfusionMatrix_skinnyNet1.fig')
...
savefig('TrainingConfusionMatrix_skinnyNet2.fig')
...
savefig('validationConfusionMatrix_skinnyNet2.fig')
...
savefig('testConfusionMatrix_skinnyNet.fig')
