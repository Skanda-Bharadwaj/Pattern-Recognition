%--------------------------------------------------------------------------
%% Deep Learning Basics : A wide neural net
%--------------------------------------------------------------------------
%
% A wide neural net is when you have fewer layers but more filters
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
layers = [
    ...
    convolution2dLayer(5,70,'Padding',[2 2],'Stride', [1,1]);             % convolution layer with 20, 5x5 filters
    reluLayer();                                                          % ReLU layer
    maxPooling2dLayer(2,'Stride',2);                                      % Max pooling layer
    
    convolution2dLayer(5,60,'Padding',[2 2],'Stride', [1,1]);             % convolution layer with 20, 5x5 filters
    reluLayer();                                                          % ReLU layer
    maxPooling2dLayer(2,'Stride',2);                                      % Max pooling layer
...
savefig('TrainingConfusionMatrix_wideNet1.fig')
...
savefig('validationConfusionMatrix_wideNet1.fig')
...
savefig('TrainingConfusionMatrix_wideNet2.fig')
...
savefig('validationConfusionMatrix_wideNet2.fig')
...
savefig('testConfusionMatrix_wideNet.fig')
